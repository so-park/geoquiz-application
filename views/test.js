...
var url;
var continent = document.getElementsByClassName('continent')[0].innerHTML.toLowerCase();
...
var beforeHighlight = 0;
  ...
  var bbStyle =new ol.style.Style({
      fill: new ol.style.Fill({
  ...
  var defaultBackgroundS = new ol.style.Style({
      fill: new ol.style.Fill({
